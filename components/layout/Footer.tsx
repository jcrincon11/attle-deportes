/* ─────────────────────────────────────────────────────────────────────
   Footer — Sedes, Contacto y Redes Sociales
   Actualiza las direcciones y teléfonos con los datos reales de Attle.
───────────────────────────────────────────────────────────────────── */
...
const SEDES = [
  {
    ...
    name: 'Sede Fontibón',
    address: 'Cra. 99 # 22H-24, Fontibón',
    city: 'Bogotá D.C., Colombia',
    hours: 'Lun–Vie 8:00 a.m. – 6:00 p.m. · Sáb 8:00 a.m. – 2:00 p.m.',
  },
  {
    type: 'Tienda',
    name: 'Sede Siete de Agosto',
    address: 'Cra. 24 # 68-10, Siete de Agosto',
    city: 'Bogotá D.C., Colombia',
...
const PHONES = [
  { label: 'Ventas',    number: '+57 (601) XXX-XXXX' },
  { label: 'WhatsApp',  number: '+57 310 XXX-XXXX'   },
]

const SOCIAL = [
  {
    label:    'Instagram',
    handle:   '@attle.deportes',
    href:     'https://instagram.com/attle.deportes',
    icon: (
  ...
  {
    label:    'Facebook',
    handle:   'Attle Deportes SAS',
    href:     'https://facebook.com/attledeportes',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="font-body text-text-subtle" style={{ fontSize: '0.72rem' }}>
            © {new Date().getFullYear()} Attle Deportes SAS — Todos los derechos reservados.
          </p>
          <p className="font-body text-text-subtle" style={{ fontSize: '0.72rem' }}>
